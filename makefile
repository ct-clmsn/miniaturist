...
all: vocab distparldalib.o parldalib.o ldalib.o gibbs.o documents.o results.o
...
distvocab: distvocab.cpp documents.o results.o
	g++ -O3 -std=c++17 -o vocab `pkg-config icu-i18n icu-io icu-uc --cflags` `pkg-config hpx_application --cflags` jch.o documents.o -lstdc++fs `pkg-config icu-i18n icu-io icu-uc --libs` -lssl -lcrypto `pkg-config hpx_application --libs` distvocab.cpp
